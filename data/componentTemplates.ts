...
export const componentTemplates: ComponentTemplate[] = [
  {
    ...
    presets: [
      ...
      },
      {
        ...
        animations: [{ name: 'glow', duration: '2s', timing: 'ease-in-out' }],
      },
      {
        name: 'Gradient',
        ...
        animations: [{ name: 'scale', duration: '2s', timing: 'ease-in-out' }],
      },
      {
        name: 'Glassmorphism',
      ...
      },
      {
        ...
        style: { 
          ...
          border: 'none',
          color: '#333',
          boxShadow: '0 10px 40px rgba(255, 154, 158, 0.4)',
        },
      },
      {
        name: 'Icon Button',
      ...
      },
      {
        ...
        animations: [{ name: 'float', duration: '3s', timing: 'ease-in-out' }],
      },
    ],
  },
  {
